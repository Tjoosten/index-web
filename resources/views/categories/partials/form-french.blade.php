...
<div class="form-group row">
    ...
    <div class="col-lg-10">
        <input type="text" class="form-control" placeholder="De naam van de categorie." name="name[fr]" value="{{ old('name.fr') }}">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-10">
        <textarea name="description[fr]" placeholder="De beschrijving van categorie" class="form-control" rows="7">{{ old('description.fr') }}</textarea>
    </div>
</div>